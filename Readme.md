# Личный проект «Барбершоп Бородинский с разными дисплеями»
...
* Вносим изменения и проверяем терминал 
---
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-adaptive/2556705-cat-energy-2) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии будет скопирован в ваш аккаунт.
...
[check-image]: https://github.com/htmlacademy-adaptive/2556705-cat-energy-2/workflows/Project%20check/badge.svg?branch=master
[check-url]: https://github.com/htmlacademy-adaptive/2556705-cat-energy-2/actions
